...
class File extends common_1.ServiceObject {
    ...
    setEncryptionKey(encryptionKey) {
        ...
        this.encryptionKeyBase64 = safe_buffer_1.Buffer.from(encryptionKey).toString('base64');
        this.encryptionKeyHash =
            crypto
                .createHash('sha256')
                // tslint:disable-next-line:no-any
    ...
    getSignedPolicy(options, callback) {
        ...
        const policyBase64 = safe_buffer_1.Buffer.from(policyString).toString('base64');
